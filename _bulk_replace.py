"""Bulk find/replace + page rename for Casey Earthworks & Pergolas scaffold."""
...
REPLACEMENTS = [
    ("https://geelongroofrestorations.com.au", "https://caseyearthworks.com.au"),
    ("geelongroofrestorations.com.au", "caseyearthworks.com.au"),
    ("geelongroofrestorations", "caseyearthworks"),
    ("Geelong Roof Restorations", "Casey Earthworks &amp; Pergolas"),
    ...
    ("/services/roof-painting/", "/services/driveway-preparation/"),
    ("/services/tile-restoration/", "/services/foundation-excavation/"),
    ...
    ("Armstrong Creek", "Emerald"),
    ("Lara", "Hampton Park"),
    ("quotes@geelongroofrestorations.com.au", "quotes@caseyearthworks.com.au"),
    (">G</text>", ">P</text>"),
]
...
def main():
    ...
    if pkg.exists():
        ...
        s = s.replace('"name": "geelongroofrestorations"', '"name": "caseyearthworks"')
