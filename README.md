# Casey Earthworks &amp; Pergolas — rank-and-rent microsite
...
| Item | Value |
|---|---|
| Domain | `caseyearthworks.com.au` (registered, GoDaddy fraud-pending) |
| Live URL (interim) | https://caseyearthworks.netlify.app |
...
├── whisper.js                # "Pete's Lead from Casey Earthworks &amp; Pergolas" played to contractor before patching caller through
...
| `TENANT_BRAND` | `Casey Earthworks &amp; Pergolas` (default) | What plays after the label — full whisper is `"Pete's Lead. Pete's Lead from Casey Earthworks &amp; Pergolas."` |
...
3. Submit to Google Search Console (`sc-domain:caseyearthworks.com.au`).
4. Set up Google Business Profile (needs registered business name "Casey Earthworks &amp; Pergolas" first).
